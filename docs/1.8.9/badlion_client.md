...
### Chunk Borders 
- [tildejustin & MicrocontrollerDev's Legacy Chunk Borders](https://modrinth.com/mod/legacy-chunk-borders-forge)
...
### ToggleChat
- Abbreviate Chat Channels
- Abbreviate Ranks
- Hide \*
  - Use ChatFilter Mod
  - [boomboompower's ToggleChat](https://github.com/boomboompower/ToggleChat/releases/latest)
- Hide Direct Messages
- Hide Shout Messages 
- Hide In-Game Team Messages 
- Hide In-Game Messages (Excludes Team Chat)
- Hide Line Separators
- Hide Friend Join/Leave Messages 
